...
#________________________________
b1 = Button(root,text="制作词云-评论",command=lambda:made(oid.get(),path.get()),bd=5, width=10, height=1)
b1.grid(row=5,column=0)
#________________________________
b1 = Button(root,text="制作词云-弹幕",command=lambda:made_2(oid.get(),path.get()),bd=5, width=10, height=1)
